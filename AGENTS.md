...
This project is indexed by GitNexus as **simple-shorten-url** (1778 symbols, 3654 relationships, 82 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
