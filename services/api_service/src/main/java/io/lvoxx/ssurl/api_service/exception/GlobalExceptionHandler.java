...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleShortCodeNotFound(ShortCodeNotFoundException ex, Locale locale) {
        ...
        pd.setDetail(resolveMessage("error.shortcode.notfound", ex.getMessage(), locale));
        return pd;
    }
    ...
    public ProblemDetail handleUrlExpired(UrlExpiredException ex, Locale locale) {
        ...
        pd.setDetail(resolveMessage("error.shortcode.expired", ex.getMessage(), locale));
        return pd;
    }
    ...
    public ProblemDetail handleDomainBlacklisted(DomainBlacklistedException ex, Locale locale) {
        // 422 — HttpStatus.UNPROCESSABLE_ENTITY is deprecated in Spring 7; use raw code
        ProblemDetail pd = ProblemDetail.forStatus(422);
        pd.setTitle("Domain Blacklisted");
        pd.setDetail(resolveMessage("error.domain.blacklisted", ex.getMessage(), locale));
        return pd;
    }
    ...
    public ProblemDetail handleUserNotFound(UserNotFoundException ex, Locale locale) {
        ...
        pd.setDetail(resolveMessage("error.user.notfound", ex.getMessage(), locale));
        return pd;
    }
    ...
    public ProblemDetail handleUrlNotFound(UrlNotFoundException ex, Locale locale) {
        ...
        pd.setDetail(resolveMessage("error.url.notfound", ex.getMessage(), locale));
        return pd;
    }
    ...
    public ProblemDetail handleUserAlreadyExists(UserAlreadyExistsException ex, Locale locale) {
        ...
        pd.setDetail(resolveMessage("error.user.exists", ex.getMessage(), locale));
        return pd;
    }
    ...
    public ProblemDetail handleRateLimitExceeded(RateLimitExceededException ex, Locale locale) {
        ...
        pd.setDetail(resolveMessage("error.ratelimit.exceeded", ex.getMessage(), locale));
        return pd;
    }
    ...
    public ProblemDetail handleUnauthorized(UnauthorizedException ex, Locale locale) {
        ...
        pd.setDetail(resolveMessage("error.unauthorized", ex.getMessage(), locale));
        return pd;
    }
    ...
    private String resolveMessage(String code, String fallback, Locale locale) {
        try {
