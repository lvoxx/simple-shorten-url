...
public class UrlController {
        ...
        public UrlController(UrlService urlService, ContextUserService contextUserService) {
        ...
        public Mono<ResponseEntity<UrlResponse>> createUrl(@Valid @RequestBody CreateUrlRequest request) {
                return contextUserService.getCurrentUser()
                                .flatMap(user -> urlService.createUrl(request, user.id(), user.username()))
